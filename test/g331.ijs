...
a=: 'abcdefghijklmnopqrstuvwxyz'
NB. (,."1 ] 5 4*"1 ] _1^#:i.4) f"2 1 a NB. #broken segfault
a=: u:'abcdefghijklmnopqrstuvwxyz'
NB. (,."1 ] 5 4*"1 ] _1^#:i.4) f"2 1 a NB. #broken segfault
a=: 10&u:'abcdefghijklmnopqrstuvwxyz'
NB. (,."1 ] 5 4*"1 ] _1^#:i.4) f"2 1 a NB. #broken segfault
a=: s:@<"0 'abcdefghijklmnopqrstuvwxyz'
NB. (,."1 ] 5 4*"1 ] _1^#:i.4) f"2 1 a NB. #broken segfault
NB. (,."1 ] 5 4*"1 ] _1^#:i.4) f"2 1 x=: ?100$1e6 NB. #broken segfault
...
NB. (,."1 ] 5 4*"1 ] _1^#:i.4)        f"2 x=: ?11 13$1e6 NB. #broken segfault
...
NB. ----------------------- x <;.0 y ---------------------------
NB. l ((<;.0 -: ]@<@(]"]);.0) , ((<;.0 -: ]@<@(]"]);.0)~ 2 1 $ ,)~) r [ l =. 1 2 1$0 [ r =. '' NB. #broken segfault
...
NB. l ((<;.0 -: ]@<@(]"]);.0) , ((<;.0 -: ]@<@(]"]);.0)~ 2 1 $ ,)~) r [ l =. _2 + (((5 + ?10),2 1) ?@$ #r) [ r =. 0.5 + i. 10 10 NB. #broken segfault
